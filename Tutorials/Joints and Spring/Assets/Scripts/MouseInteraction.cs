    ...
    public class MouseInteraction : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            if (ShootRay() != null && ShootRay().GetComponent<MonoParticle>() != null) //as long shootray does not equal null...
            {
                ...
                _current.GetComponent<MonoParticle>().AnchorPoint = (!_current.GetComponent<MonoParticle>().AnchorPoint); //determines if the particle clicked on becomes an anchor point or not
            }
            else
            {
                _current = null;
        ...
        public void LateUpdate()
        {
            ...
            if (!Input.GetMouseButton(0) || _current == null) return;
